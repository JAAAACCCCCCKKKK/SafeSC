...
from graph.router import AuditRequest, route_condition, router_node
from graph.single_pkg import NODE_RESOLVE_SINGLE, resolve_single_package
from graph.specialists import SPECIALIST_MODULES
...
def run(
    ...
    *,
    ...
    from graph.llm_client import build_specialist_deps  # lazy: needs the anthropic seam
