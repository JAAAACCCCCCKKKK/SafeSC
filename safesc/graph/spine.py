...
def _scan_signal_to_graph(s) -> Signal:
    """safesc.tools.scan.signals.models.Signal -> safesc.graph.state.Signal (Stage 3)."""
    return Signal(
...
def load_default_tools() -> InjectedTools:
    ...
    from safesc.tools.index.core.discovery import DiscoveredFile  # type: ignore
    from safesc.tools.scan.signals import collector  # type: ignore
